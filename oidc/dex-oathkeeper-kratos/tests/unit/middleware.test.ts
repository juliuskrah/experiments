...
// @ory/nextjs's /self-service/* proxy branch (that's a separate integration concern
// covered by research.md §7a and the quickstart.md manual scenarios). Stubbing it out
// also avoids @ory/nextjs/middleware's `import ... from "next/server"` (no extension),
// which Vite's ESM resolver cannot follow outside Next.js's own build pipeline.
