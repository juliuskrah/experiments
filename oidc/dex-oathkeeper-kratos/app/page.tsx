...
export default function WelcomePage() {
  ...
  useEffect(() => {
    // Covers both an explicit logout and a failed silent re-authorization (FR-007): the
    // middleware's optimistic cookie check lets an access-token-expired session cookie through,
    // so this client-side redirect is what actually enforces "no stuck state" (SC-004) once
