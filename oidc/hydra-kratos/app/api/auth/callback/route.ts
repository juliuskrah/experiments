...
import { decodePkceCookie, exchangeAuthorizationCode, getHydraConfig, PKCE_COOKIE_NAME } from "@/app/lib/oidc-client";
...
export async function GET(request: NextRequest) {
  ...
  let tokens;
  try {
    // openid-client requires a plain URL instance; NextRequest.nextUrl is a NextURL subclass and
    // fails openid-client's instanceof check.
