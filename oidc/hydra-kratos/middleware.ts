...
// login flow can never resume after Kratos authentication (found + fixed in the sibling
// dex-oathkeeper-kratos app; ported here since app/kratos/* pages are identical).
...
export const config = {
  matcher: [
    "/((?!api/auth|login|kratos|hydra|_next/static|_next/image|favicon.ico).*)",
  ],
};
